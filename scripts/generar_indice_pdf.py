# -*- coding: utf-8 -*-
"""
El indice de las 6.830 fichas en PDF, vertical y sobre el membrete.
...
SALIDA = os.path.join(ESCRITORIO, 'INDICE DE FICHAS - PADRON POROTOG.pdf')
...
def main():
    ...
    doc = SimpleDocTemplate(
        SALIDA, pagesize=A4, title='Índice de fichas — Padrón Guanguilquí–Porotog',
    ...
    historia = [
        Paragraph('Índice de fichas del padrón', st_h), Spacer(0, 1.5 * mm),
        Paragraph('Catastro socioeconómico y productivo predial · Sistema de riego '
                  'comunitario Guanguilquí–Porotog', st_s),
        Spacer(0, 1 * mm),
